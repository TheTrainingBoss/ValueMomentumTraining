using SFDev2022.Configurations;
using System;
    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        private void Bootstrapper_Initialized(object sender, Telerik.Sitefinity.Data.ExecutedEventArgs e)
        {
           if (e.CommandName == "Bootstrapped")
            {
                Config.RegisterSection<TheTrainingbossConfig>();
                EventHub.Subscribe<IMediaContentDownloadedEvent>(evt => MyOwnFunction(evt));
            }
        }

        private void MyOwnFunction(IMediaContentDownloadedEvent evt)
        {
        ...
        {
            EventHub.Unsubscribe<IMediaContentDownloadedEvent>(MyOwnFunction);
        }
    }
}